...
v2: 8/18/13 - 10.8.4 Shell Script Realtek ALC888 AppleHDA.kext Patching

Requirements
1. Native S/L/E/AppheHDA.kext (restore native AppleHDA.kext with Combo Update)
2. alc888-84 - Mountain Lion 10.8 - 10.8.4/AppleHDA.kext_v2.3.7
...
1. Downloads/audio_ALC888-master/audio_alc888-84_patch.sh
...
audio_alc888-84_patch.sh
README.txt
Files:
888.zip

Details - audio_ALC888-rv-patch script  (see Reqirements)
...
3. Run script
3a. Downloads/audio_ALC888-master/audio_alc888-84_patch
...
4. Terminal/audio_alc888-84_patch window
_____________________________

Last login: Tue Aug 13 19:43:30 on console
$ . . ./Downloads/audio_ALC888-master/audio_alc888-84_patch.sh ; exit;
